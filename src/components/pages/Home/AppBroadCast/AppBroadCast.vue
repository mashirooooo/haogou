  ...
  <div id="app-broad-cast">
    ...
    <div class="swiper-container app-broad-cast">
      <div class="swiper-wrapper" >
        <div class="swiper-slide" style="width: 243px; margin-right: 30px;" v-for="(item, idx) in BroadCast" :key="item.goodsId + idx">
          <a class="external" href="https://m.hao24.com/goods/228421.html">
